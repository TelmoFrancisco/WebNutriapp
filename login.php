      ...
      <form class="login-form" action="" method="POST">
        <div class="login-wrap">
            ...
            <div class="input-group">
              ...
              <input type="text" name="p_log_username" id="p_log_username" class="form-control" placeholder="Username" autofocus>
            </div>
            <div class="input-group">
                <span class="input-group-addon"><i class="icon_key_alt"></i></span>
                <input type="password" name="p_log_password" id="p_log_password" class="form-control" placeholder="Password">
            </div>
